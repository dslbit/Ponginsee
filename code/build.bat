...
set common_compiler_flags=/nologo /W3 /WX /Oi /utf-8 /fp:precise ..\code\win32_pong.c
set debug_compiler_flags=/Od /Z7 /Fdwin32_pong_debug.pdb /Fowin32_pong_debug.obj /Fewin32_pong_debug.exe
set common_linker_flags=/subsystem:windows /opt:ref /incremental:no user32.lib
